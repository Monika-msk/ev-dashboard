...
},
{
  ...
  distanceFromHighway: '2.1 km',
  siteSize: '2200 m²',
  amenities: 'Truck terminal, canteen, pump',
  substation: 'APEPDCL Vizag East (~1.7 km)',
  renewables: 'Rooftop PV',
...
},
{
  ...
  distanceFromHighway: '2.4 km',
  siteSize: '2100 m²',
  amenities: 'Petrol station, dhaba cluster, truck halt',
  substation: 'PSPCL Zirakpur (~1.8 km)',
  renewables: 'Rooftop solar nearby',
  contact: 'pspcl.zirakpur@punjab.gov.in'
},
{
  id: 'V2',
  coordinates: [75.8813, 30.8665],
  corridor: 'Chandigarh – Ludhiana – Amritsar',
  highway: 'NH 44',
  distanceFromHighway: '2.3 km',
  siteSize: '2200 m²',
  amenities: 'Highway rest stop, repair workshop, fuel pump',
  substation: 'PSPCL Ludhiana South (~1.6 km)',
  renewables: 'NA',
  contact: 'pspcl.ludhiana@punjab.gov.in'
},
{
  id: 'V3',
  coordinates: [74.8780, 31.5889],
  corridor: 'Chandigarh – Ludhiana – Amritsar',
  highway: 'NH 3',
  distanceFromHighway: '2.7 km',
  siteSize: '2300 m²',
  amenities: 'Truck depot, café, servicing bay',
  substation: 'PSPCL Amritsar East (~2.2 km)',
  renewables: 'Rooftop solar installations nearby',
